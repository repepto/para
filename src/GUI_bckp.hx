...
class GUI extends TileGroup
{
	...
	function buyAppear()
	{
		...
		if (Game.game.lang == "ru") markerMover(400)
	...
	public function setMoney()
	{
		...
		if (Game.game.lang == "ru") money = new Fnt(470, 500, "ltymub " + Game.game.money, Game.game.layerGUI, 1, 1, true)
		else money = new Fnt(470, 500, "money " + Game.game.money, Game.game.layerGUI, 1, 1, true);
		addChild(money);
	}
	...
	public function endBattle(message:String, messageNext:String, bonMes:String = null)
	{
		...
		{ 
			...
			if (Game.game.currentLevel > 1) 
			{
				...
				if (Game.game.lang == "ru") goReset = new Fnt(500, 500, "yujdfz buhf", Game.game.layerGUI, 0, .7, true);
				else goReset = new Fnt(500, 500, "new game", Game.game.layerGUI, 0, .7, true);
				addChild(goNewRing);
				addChild(goReset);
			}
	...
	function appearReady()
	{
		...
		{ 
			...
			{
				goNewRing = new TechnoRings(500, 500, 1, .5);
				if (Game.game.lang == "ru") goReset = new Fnt(500, 500, "yjdfz buhf", Game.game.layerGUI, 0, .7, true)
				else goReset = new Fnt(500, 500, "new game", Game.game.layerGUI, 0, .7, true);
				addChild(goNewRing);
				addChild(goReset);
			}
